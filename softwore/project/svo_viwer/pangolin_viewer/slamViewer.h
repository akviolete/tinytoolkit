...
*   通信协议
*/
#define VIEWER_IMAGE 0               //图像
#define VIEWER_KEY_POINT 1           //特征点
#define VIEWER_TRAJECTORY 2          //轨迹
#define VIEWER_ALL_POINT_CLOUD 3      //所有点云
#define VIEWER_CURRENT_POINT_CLOUD 4  //当前点云
...
namespace pangolin_viewer
{
    ...
    public:
        ...
        void RunData(std::size_t protocol, const char *data, std::size_t size);
    ...
    private:
         ...
         * @param width
         */
        void draw_camera(const Mat44_t &cam_pose_wc, const float width) const;
    ...
    private:
        ...
        std::vector<Eigen::Vector3d> _allPointCloud;
        std::vector<Eigen::Vector3d> _currentPointCloud;
