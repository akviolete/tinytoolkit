...
namespace Toolkit
{
    ...
    TCPSessionPipe::TCPSessionPipe(ITCPSession *session, TINY_TOOLKIT_SOCKET_TYPE socket,
                                   TINY_TOOLKIT_SOCKET_HANDLE handle) : _cache(session->_cacheSize),
                                                                        _session(session),
                                                                        _socket(socket),
                                                                        _handle(handle)
    {
    ...
    TCPServerPipe::TCPServerPipe(ITCPServer *server, TINY_TOOLKIT_SOCKET_TYPE socket, TINY_TOOLKIT_SOCKET_HANDLE handle)
            : _server(server),
              _socket(socket),
              _handle(handle)
    {
